    ...
    <Container className="mt-4">
      <Card>
        <Card.Header className="d-flex justify-content-between align-items-center bg-success text-white">
          <h2 className="mb-0">Tipos de Equipos</h2>
      ...
      <Modal show={showConfirm} onHide={cancelDelete} centered>
        ...
        <Modal.Body>
          ¿Estás seguro que deseas eliminar este tipo de equipo? Esta acción no se puede deshacer.
        </Modal.Body>
        <Modal.Footer>
      ...
      <Modal show={show} onHide={() => setShow(false)} size="lg">
        <Modal.Header>
          <Modal.Title>Detalles del tipo de equipo</Modal.Title>
        </Modal.Header>
        <Modal.Body>
